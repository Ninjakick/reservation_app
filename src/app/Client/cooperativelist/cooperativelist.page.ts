...
import { CooperativedetailPage } from '../cooperativedetail/cooperativedetail.page'; 

@Component({
  selector: 'app-cooperativelist',
  templateUrl: './cooperativelist.page.html',
  styleUrls: ['./cooperativelist.page.scss'],
})
export class CooperativelistPage implements OnInit {
